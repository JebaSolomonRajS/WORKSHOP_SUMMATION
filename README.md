...
### MainActivity.java:
```java
package com.death.workshop_summation;
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:theme="@style/Theme.WORKSHOP_SUMMATION"
        tools:targetApi="31">
        <activity
...
![WORKSHOP_SUMMATION](https://github.com/JebaSolomonRajS/WORKSHOP_SUMMATION/assets/139432449/67a2716c-af53-4299-b6de-079009ab318e)
